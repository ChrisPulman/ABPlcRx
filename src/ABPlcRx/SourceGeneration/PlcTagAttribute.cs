...
{
    /// <summary>Initializes a new instance of the <see cref="PlcTagAttribute"/> class for a property-declared tag.</summary>
    /// <param name="tagName">The PLC tag name.</param>
    public PlcTagAttribute(string tagName) => TagName = tagName;

    /// <summary>Initializes a new instance of the <see cref="PlcTagAttribute"/> class for a generated property.</summary>

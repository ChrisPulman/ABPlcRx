...
public static class PlcTagStatus
{
    ...
    /// <summary>The operation failed due to incorrect configuration and is usually returned from a remote system.</summary>
    ...
    /// <summary>An error returned by a remote system when something is incorrectly duplicated, such as a duplicate connection ID.</summary>
    ...
    /// <summary>Usually an internal error, but can be returned when an invalid handle is used with an API call.</summary>
